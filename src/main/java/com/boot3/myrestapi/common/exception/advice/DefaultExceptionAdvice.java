...
import com.boot3.myrestapi.common.exception.advice.ErrorObject;
...
//    }
    ...
    protected ProblemDetail handleException(BusinessException e) {
        ...
        problemDetail.setTitle("Not Found");                    // 제목
        problemDetail.setDetail(e.getMessage());                // Error 상세메시지
        problemDetail.setProperty("errorCategory", "Generic");  // setProperty 를 사용해서 필요한 에러항목 추가 가능
        problemDetail.setProperty("timestamp", Instant.now());  // 에러 시간
